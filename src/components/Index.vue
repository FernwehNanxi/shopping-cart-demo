                          ...
                          <dl class="option dl-horizontal">
                              ...
                              <dd>
                                  <ul>
                                      ...
                                      <li v-for="(value,key) in iPhone6S.style" @click="changeStyle(key)" :class="{active:iPhone6S.activeStyleUrl==value}"><span v-text="key"></span></li>
                                  </ul>
                              </dd>
                          </dl>
                          <dl class="option dl-horizontal">
                              ...
                              <dd>
                                  <ul>
                                      <!--<li v-for="price in iphone6S.storage" @click="changePrice($key,price)" :class="{active:iphone6S.price==price}"><span v-text="$key"></span></li>-->
                                      <li v-for="(value,key) in iPhone6S.storage" @click="changePrice(key)" :class="{active:iPhone6S.price==value}"><span v-text="key"></span></li>
                                  </ul>
                              </dd>
                          </dl>
                      </div>
